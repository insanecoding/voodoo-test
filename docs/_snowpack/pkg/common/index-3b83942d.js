...
function getUTCISOWeek(dirtyDate) {
  ...
  var date = toDate(dirtyDate);
  var diff =
    startOfUTCISOWeek(date).getTime() - startOfUTCISOWeekYear(date).getTime(); // Round the number of days to the nearest integer
...
export {
  startOfYesterday as a,
  toInteger as b,
  addMilliseconds as c,
  startOfDay as d,
  isValid as e,
  format as f,
  getTimezoneOffsetInMilliseconds as g,
  addLeadingZeros as h,
  isAfter as i,
  subMilliseconds as j,
  getUTCISOWeek as k,
  locale as l,
  getUTCWeek as m,
  getUTCWeekYear as n,
  startOfUTCWeek as o,
  startOfUTCISOWeek as p,
  isProtectedWeekYearToken as q,
  requiredArgs as r,
  startOfToday as s,
  toDate as t,
  throwProtectedError as u,
  isProtectedDayOfYearToken as v,
  longFormatters as w,
  formatters as x,
};
