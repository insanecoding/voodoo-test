      ...
      context.fetchFn = function () {
        ...
        var fetchMore =
          (_context$fetchOptions = context.fetchOptions) == null
            ...
            ? void 0
            : _context$fetchOptions2.fetchMore;
        ...
        if (!oldPages.length) {
          ...
          (function () {
            newPageParams = [];
            var manual =
              typeof context.options.getNextPageParam === 'undefined'; // Fetch first page
...
var QueryErrorResetBoundaryContext = /*#__PURE__*/ react.createContext(
  createValue(),
); // HOOK
